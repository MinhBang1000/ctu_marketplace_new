            ...
            return (
                <div className='home'>
                    ...
                    {/* className='home__search__block' */}
                        <div id='home__search__block' className={showFilter? 'home__search__block home__search__block--show-filter' : 'home__search__block'}> 
                            <div className='home__search__block__search'>
                                ...
                                <div className='home__search__block__search__filter' onClick={handleFilter}>
                                    {/* <img src={require('../../../../assets/images/filter.png')}  alt='filter' width={50}/> */}
                                    <svg id="Group_35" data-name="Group 35" xmlns="http://www.w3.org/2000/svg" width="40" height="30" viewBox="0 0 66.58 57.184">
                            ...
                            <div className='home__search__block__filter'>
                                rew
                            </div>
                        </div>
                    </div>
