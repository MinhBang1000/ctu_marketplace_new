...
const ProjectList = (props) => {
    ...
    const changePage = (e, page) =>  {
        ...
        setProjects(projects.slice(itemPerPage*(page-1), itemPerPage*(page-1)+itemPerPage));
        ...
        if(props.projects){
            ...
            return (
                <div className='home'>
                    ...
                    <div className='home__line' id="home__line" style={{backgroundColor: 'black', padding: '20px 0', position: 'sticky', zIndex: 9999, top: 100, display: searchDisplay? 'block' : 'none'}}>
                        <div className='home__search__block' style={{margin: 'auto'}}>
                            ...
                            <div className='home__search__block__input'>
                                <input type='text' value={search} onInput={(e) => setSearch(e.target.value)} placeholder='Tìm kiếm'/>
                            </div>
...
{/* Overhere */}
{
                                projects.map((item, index) => <div className='mk-card-horizontal' key={index}>
                                            ...
                                            <div className="mk-card-body">
                                                ...
                                                >
                                                    <h4 className="fw-bold text-uppercase product-card__description__name">
                                                        {/* {renderHighlightOnSearch(name)} */} {item.name}
                                                    </h4>
